...
[![Unit Tests](https://github.com/LiquidEnergyDollar/oracle-contracts/actions/workflows/unit-test.yaml/badge.svg)](https://github.com/LiquidEnergyDollar/oracle-contracts/actions/workflows/unit-test.yaml)
[![Integration Tests](https://github.com/LiquidEnergyDollar/oracle-contracts/actions/workflows/integration-test.yaml/badge.svg)](https://github.com/LiquidEnergyDollar/oracle-contracts/actions/workflows/integration-test.yaml)
[![Slither Static Analysis](https://github.com/LiquidEnergyDollar/oracle-contracts/actions/workflows/slither.yaml/badge.svg)](https://github.com/LiquidEnergyDollar/oracle-contracts/actions/workflows/slither.yaml)
[![Lint](https://github.com/LiquidEnergyDollar/oracle-contracts/actions/workflows/lint.yaml/badge.svg)](https://github.com/LiquidEnergyDollar/oracle-contracts/actions/workflows/lint.yaml)
...
```sh
git clone https://github.com/LiquidEnergyDollar/oracle-contracts && cd oracle-contracts
```
